...
@bp_page_pallets.route('/dsn_find_ajax', methods=['POST', 'GET'])
...
@bp_page_pallets.route('/dsn_delete_sn_ajax', methods=['POST', 'GET'])
...
@bp_page_pallets.route('/dsn_save_edit_sn_ajax', methods=['POST', 'GET'])
