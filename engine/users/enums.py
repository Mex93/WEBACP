...
class USER_SECTIONS_TYPE(IntEnum):
    ...
    ACCESS_PALLET_DELETE_ALL = 27,
    ACCESS_PALLET_DELETE_DEVICE = 28,
    ACCESS_PALLET_ADD_TV = 29,
    ACCESS_PALLET_FIND = 30,
    ACCESS_PALLET_CHANGED_STATUS = 31,
    ACCESS_PALLET_CHANGED_INFO = 32
