...
class CDeviceSN:
    __cparams = [
        ...
        ['model_id', SQL_ASSEMBLED_TV_FIELDS.fd_tvfk, EDIT_FIELD.NO_EDIT, int, 'Номер модели'],
        ...
        ['device_sn', SQL_ASSEMBLED_TV_FIELDS.fd_tv_sn, EDIT_FIELD.NO_EDIT, int, 'Серийный номер устройства'],
